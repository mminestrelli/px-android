...
public class CurrenciesUtil {
    ...
    private static Map<String, Currency> currenciesList = new HashMap<String, Currency>() {{
        ...
        put(CURRENCY_CHILE, new Currency(CURRENCY_CHILE, "Peso chileno", "$", 2, ",".charAt(0), ".".charAt(0)));
        put(CURRENCY_COLOMBIA, new Currency(CURRENCY_COLOMBIA, "Peso colombiano", "$", 2, ",".charAt(0), ".".charAt(0)));
